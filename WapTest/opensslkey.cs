...
namespace Alipay.Class
{
    ...
    public class opensslkey
    {
      ...
      public static RSACryptoServiceProvider DecodePEMKey(string pemstr)
        ...
        /// <returns></returns>
        private static byte[] GetPkcs12(RSA rsa, String keycontainer, String cspprovider, uint KEYSPEC, uint cspflags, SecureString pswd)
        {
            byte[] pfxblob = null;
        ...
        private static IntPtr CreateUnsignedCertCntxt(String keycontainer, String provider, uint KEYSPEC, uint cspflags, String DN)
        {
            ...
            if (hCertCntxt == IntPtr.Zero)
                return IntPtr.Zero; //showWin32Error(Marshal.GetLastWin32Error());
