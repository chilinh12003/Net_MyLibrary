...
using MyUtility;
using System.Web;
namespace MyBase.MyLoad
{
    /// <summary>
    /// Đây là lớp base dành cho các class load template trong MyLoad của từng wap,website
    /// </summary>
    public class MyLoadBase
    {
        MyLog mLog = new MyLog(typeof(MyLoadBase));

        /// <summary>
        /// Trang wap hiện tại
        /// </summary>
        public MyWap.MyWapBase CurrentWapBase
        {
            get;
            set;
        }
       /// <summary>
        ...
        /// 
        /// </summary>
        public string mTemplatePath_Script;
        ...
        public MyLoadBase(MyWap.MyWapBase CurrentWapBase)
        {
